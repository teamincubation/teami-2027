...
<div class="form-card">
    <form action="/admin/certificates/edit/<?= $cert['id'] ?>" method="POST" enctype="multipart/form-data" autocomplete="off">
        <?= csrf_field() ?>
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <input type="text" id="certificate_number" name="certificate_number" required value="<?= htmlspecialchars($cert['certificate_number']) ?>" class="form-control">
            ...
            <div class="form-group">
                ...
                <input type="text" id="holder_name" name="holder_name" required value="<?= htmlspecialchars($cert['holder_name']) ?>" class="form-control">
            </div>
            ...
            <div class="form-group">
                ...
                <select id="type_id" name="type_id" required class="form-control">
                    <?php foreach ($types as $type): ?>
                        <option value="<?= $type['id'] ?>" <?= $cert['type_id'] == $type['id'] ? 'selected' : '' ?>><?= htmlspecialchars($type['name']) ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="date" id="issued_date" name="issued_date" required value="<?= date('Y-m-d', strtotime($cert['issued_date'])) ?>" class="form-control">
            </div>

            <!-- Programme -->
            <div class="form-group">
                <label for="associated_programme">Programme / Duration</label>
                <input type="text" id="associated_programme" name="associated_programme" value="<?= htmlspecialchars($cert['associated_programme'] ?? '') ?>" class="form-control">
            ...
            <div class="form-group">
                ...
                <select id="status" name="status" class="form-control">
                    <option value="Active" <?= $cert['status'] === 'Active' ? 'selected' : '' ?>>Active (Verified & Accessible)</option>
            ...
            <!-- PDF Upload -->
            <div class="form-group">
                <label for="file">Certificate PDF Document (Leave empty to keep current)</label>
                <input type="file" id="file" name="file" accept="application/pdf" class="form-control">
                <span class="help-text">Current File: <code><?= htmlspecialchars($cert['file_path']) ?></code></span>
            </div>

            <!-- Grade -->
            <div class="form-group">
                <label for="grade">Evaluation Grade</label>
                <input type="text" id="grade" name="grade" value="<?= htmlspecialchars($meta['grade'] ?? 'Outstanding') ?>" class="form-control">
            </div>

            <!-- Remarks -->
            <div class="form-group full-width">
                <label for="remarks">Remarks / Contribution Details</label>
                <textarea id="remarks" name="remarks" rows="3" class="form-control"><?= htmlspecialchars($meta['remarks'] ?? '') ?></textarea>
            </div>
        </div>
