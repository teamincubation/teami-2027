...
<div class="form-card">
    <form action="/admin/timelines/edit/<?= intval($milestone['id']) ?>" method="POST" autocomplete="off">
        <?= csrf_field() ?>
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <input type="number" id="year" name="year" required min="2000" max="2100" placeholder="e.g. 2026" class="form-control" value="<?= intval($milestone['year']) ?>">
            ...
            <div class="form-group">
                ...
                <input type="text" id="title" name="title" required placeholder="e.g. Foundation / Launch" class="form-control" value="<?= htmlspecialchars($milestone['title']) ?>">
            ...
            <div class="form-group full-width">
                ...
                <input type="text" id="impact_stats" name="impact_stats" placeholder="e.g. 400+ Volunteers / 1000+ Beneficiaries" class="form-control" value="<?= htmlspecialchars($milestone['impact_stats'] ?? '') ?>">
            ...
            <div class="form-group full-width">
                ...
                <textarea id="description" name="description" required rows="4" placeholder="Briefly describe what was accomplished during this period..." class="form-control"><?= htmlspecialchars($milestone['description']) ?></textarea>
            ...
            <div class="form-group">
                ...
                <input type="number" id="display_order" name="display_order" min="0" class="form-control" value="<?= intval($milestone['display_order']) ?>">
            ...
            <div class="form-group" style="display: flex; align-items: center; padding-top: 1.75rem;">
                <label class="switch-container">
                    <input type="checkbox" id="active" name="active" value="1" <?= $milestone['active'] ? 'checked' : '' ?>>
        ...
        <div class="form-actions-bar">
            ...
            <button type="submit" class="btn-submit">Update Milestone <i class="fa-regular fa-circle-check" style="margin-left: 0.5rem;"></i></button>
        </div>
    </form>
</div>
